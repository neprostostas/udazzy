          ...
          <div v-if="isReportCommentBlockOpen" class="reportCommentMainButton">
            ...
            <div class="input-group">
              <div class="complaint-input">
                ...
                <img class="clear-svg" @click="inputtedText = ''" :src="require('@/modules/reportUserModal/assets/icons/clear.svg')" alt="clear">
              </div>
            </div>
...
export default defineComponent({
  ...
  setup(props) {
    ...
    watchEffect(() => {
      ...
      // console.group()
      // console.log("isMainBlockOpen: ", isMainBlockOpen.value);
      // console.log("isReportBlockOpen: ", isReportBlockOpen.value);
      // console.log("isReportCommentBlockOpen: ", isReportCommentBlockOpen.value);
      // console.log("isThanksForReport: ", isThanksForReport.value);
      // console.log("isBlockOpen: ", isBlockOpen.value);
      // console.groupEnd()
    });
