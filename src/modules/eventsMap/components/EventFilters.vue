  ...
  <div class="filters">
    <div class="filters-panel">
      <div class="quick-filters">
        <div
            class="item"
            v-if="activeQuickFilters.today || activeQuickFilters.thisWeek"
        ...
        <div
            class="item"
            v-if="filter_params.byPromoterId"
            :class="filter_params.byPromoterId ? 'active' : ''"
        >
          <button @click="$emit('filterReset')"><small>Events from</small> {{ promoterName }}</button>
          <div
              @click="$emit('filterReset')"
              class="cancel"
          ><img
        ...
        <div
            class="item"
            :class="filter_params.onlyMyEvents ? 'active' : ''"
        >
          <button @click="filter_params.onlyMyEvents = true">Only my events</button>
          <div
              @click="filter_params.onlyMyEvents = false"
              class="cancel"
          ><img
              src="@/assets/img/icons/cross-icon.svg"
              alt=""
...
// import {filterMarkersBySearch} from "@/components/js/filterMarkersBySearch";
