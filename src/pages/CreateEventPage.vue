...
export default defineComponent({
  ...
  setup() {
    ...
    // watch(placeState.value, () => {
    //   state.value.city_id = placeState.value.city.id
    //   state.value.type = placeState.value.type.id
    // });
    ...
    // watch(placeState.value, () => {
    //   if(placeState.value.type.name === 'Nightclub')
    //     placeState.value.type['type_google'] = 'night_club'
    //   else if(placeState.value.type.name === 'Restaurant')
    //     placeState.value.type['type_google'] = 'restaurant'
    //   else if(placeState.value.type.name === 'Rooftop')
    //     placeState.value.type['type_google'] = 'roofing_contractor'
    //   else
    //     placeState.value.type['type_google'] = 'roofing_contractor'
    // })
    ...
    function uploadAvatar(input) {
      ...
      reader.onloadend = () => {
        ...
        // state.value[input.target.name] = rawImg
