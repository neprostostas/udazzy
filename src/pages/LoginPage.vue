  ...
  <div class="bg-dark bottom-nav-padd h-100 text-center pt-80">
    <div class="container">
      ...
      <div class="form-wrapper">
            ...
            <div v-if="codeSent === false" class="input-group text-left mt-15">
              <label class="checkbox">
                ...
                >I agree to receive SMS/text massages. SMS data rates may
                  apply. I agree with
                  <a
                      onclick="cordova.InAppBrowser.open('https://udazzy.com/privacy-policy', '_blank', 'location=yes')"
                  >Privacy Policy</a
                  ></span
                >
              </label>
        ...
        <!--        <button @click="recoveryModal = !recoveryModal" class="recover-button">Recover account</button>-->
        <!--        <RecoveryModal v-if="recoveryModal" @close="recoveryModal = false" />-->
      </div>
    </div>
  </div>
        ...
        axios
            ...
            .then((res) => {
              if (res.data.status === "success") {
                ...
                console.log(user.last_name.length === 0);
                console.log(user.dob.length === 0);
                console.log(user.first_name.length === 0);
