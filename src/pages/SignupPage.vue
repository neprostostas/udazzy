            ...
            <div class="form-wrapper">
              ...
              <div class="row mb-10">
                <div class="input-group w100 checkbox text-left">
                  ...
                  <label class="for_checkbox" for="accept_rules"> <a class="link-policy"
                                                                     onclick="cordova.InAppBrowser.open('https://udazzy.com/privacy-policy', '_blank', 'location=yes')">Accept
...
export default defineComponent({
  ...
  setup() {
    ...
    console.log('user', dataStatus.value);
    ...
    console.log('lstname', dataStatus)
    const state = ref({
