      ...
      <div class="swap-buttons">
        ...
        <div v-if="edition" class="block-details">
           ...
           <div>
             ...
             <InputImages :images="images" @update="updateImages" />
          ...
          <div class="preview-container">
            <div class="preview-center">
              <div class="item photo-preview">
                  ...
                  <EventEditBackgroundFilter style="z-index: 2; pointer-events: none" />
                  <Loader v-if="!sources_loaded" />

                  <EventAvatar class="header-img" :img="state?.images" />
...
import EventAvatar from "@/components/EventAvatar.vue";
  ...
  setup(props) {
    ...
    onBeforeMount(() => {
      ...
      if(state.value.images) {
        images.value.push(state.value.images)
      }


    })

    function updateImages(imagesNew) {
      state.value.images = imagesNew
      console.log("event.photos: ", state.value.images);
    }
    ...
    return { alert, event_data, loader_active, sources_loaded, state, v$, submitForm, uploadAvatar, loaded, edition, view, event_store, images, updateImages }
  },
})
</script>
