  ...
  <div class="welcome-page-wrapper bg-dark h-100 overflow-hidden"
    ...
    <div id="welcome-screen" class="welcome-screen inner-padd" :class="welcomeScreen ? 'animated' : ''">
      <div class="logo-wrapper">
        <div class="logo logo-big"><img src="../assets/img/logo-white.svg" alt="uDazzy"></div>
      </div>
...
.welcome_page_1 {
  background-image: url("../modules/welcomePage/assets/img/welcome-1.png");
}

.welcome_page_2 {
  background-image: url("../modules/welcomePage/assets/img/welcome-2.png");
}

.welcome_page_3 {
  background-image: url("../modules/welcomePage/assets/img/welcome-3.png");
}
